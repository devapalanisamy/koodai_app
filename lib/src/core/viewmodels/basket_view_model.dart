...
class BasketViewModel extends BaseViewModel {
  ...
  Future<void> chooseDeliveryType() async {
    _orderService.setProducts(basket.soldProducts());
    _orderService.setNumberOfItems(basket.totalNumberOfItems);
    _orderService.setTotalCost(basket.total());
    await _navigationService.pushNamed(
      RoutePaths.chooseDeliveryType,
      navigationFlow: NavigationFlow.Default,
      arguments: basket.total(),
    );
  }
